export const Bio = {
  ...
  roles: [
    ...
    'Desarrollador Mobile app',
    'Diseñador UI/UX',
    'Programador'
  ],
  description:
    'Persona motivada y versátil, siempre con ganas de asumir nuevos retos. Con una pasión por el aprendizaje, me dedico a ofrecer resultados de alta calidad. Con una actitud positiva y una mentalidad de crecimiento, estoy listo para hacer una contribución significativa y lograr grandes cosas.',
  resume: '/CV.pdf',
  twitter: 'https://twitter.com/CrissACM1',
